...
namespace cltj {
    ...
    public:
        ...
        compact_trie_v3(sdsl::bit_vector &_bv, sdsl::int_vector<> &_seq) {
             m_bv = _bv; 
             m_seq = _seq;
...
/*        compact_trie_v3(const std::vector<spo_triple> &D, uint8_t order[], uint64_t n_levels) {
	    ...
	    v0.push_back(c0);
            ...
            m_root_degree = v0.size(); // OJO, check this
            cout << "el rrut degree deberia ser " << m_root_degree << endl; 
            uint64_t c1, c2;
...
*/
        ...
        */
        ...
        size_type serialize(std::ostream &out, sdsl::structure_tree_node *v = nullptr, std::string name = "") const {
            ...
            // OJO DIEGO: falta escribir aqui la altura del trie y el m_root_degree, tambien revisar eso en los otros constructores
        ...
        void load(std::istream &in) {
            ...
            // OJO DIEGO: falta leer la altura del trie y m_root_degree
        }
