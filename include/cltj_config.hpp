...
// s=0, p=1, o=2, t=3 
// El indice del arreglo está dado por el prefijo de largo 2 del orden actual
// Por ejemplo, el indice POS corresponde al prefijo actual PO de largo 2.
// Cada una de las 4 entradas correspondientes a un orden indican a que trie hay que moverse
// si se sigue por ese estado. La segunda componente de cada par indica si hay que hacer
// trie switching o no. Si me muevo a un trie adyacente (o no me muevo) no estoy haciendo trie switching, por lo 
// que en ese caso el segundo componente de ese par es 0. Por ejemplo, si estamos en POS en realidad hemos visto
// el prefijo PO. La entrada "S" de ese orden entonces almacena (POS, 0), indicando que nos quedamos en POS y que
// no nos movemos. Para POS y "T", tenemos (POT, 0), indicando que nos movemos a POT pero sin hacer trie switching.
// en este caso solo estamos usando el metatrie.
...
const static switches_type trie_map_exists_2 = {{{-1, false, 0}, {-1, false, 0}, {SPOT, false, 0}, {SPT, false, 1}}, //SPOT
                                         {{-1, false, 0}, {-1, false, 0}, {SPOT, false, 0}, {SPT, false, 1}}, //SPT
                                         {{-1, false, 0}, {OSP, true, 0}, {-1, false, 0}, {OST, true, 1}}, //SO
                                         {{-1, false, 0}, {TSPO, true, 0}, {TSO, true, 1}, {-1, false, 0}}, //ST
                                         {{POS, false, 0}, {-1, false, 0}, {-1, false, 0}, {POT, false, 1}}, //POS
                                         {{POS, true, 0}, {-1, false, 0}, {-1, false, 0}, {POT, false, 1}}, //POT
                                         {{-1, false, 0}, {-1, false, 0}, {SPOT, true, 0}, {SPT, true, 1}}, //PS
                                         {{TPS, true, 3}, {-1, false, 0}, {TPOS, true, 2}, {-1, false, 0}}, //PT
                                         {{-1, false, 0}, {OSP, false, 0}, {-1, false, 0}, {OST, false, 1}}, //OSP
                                         {{-1, false, 0}, {OSP, false, 0}, {-1, false, 0}, {OST, false, 1}}, //OST
                                         {{POS, true, 0}, {-1, false, 0}, {-1, false, 0}, {POT, true, 1}}, //OP
                                         {{TOSP, true, 4}, {TOP, true, 5}, {-1, false, 0}, {-1, false, 0}}, //OT
                                         {{-1, false, 0}, {TSPO, false, 0}, {TSO, false, 1}, {-1, false, 0}},  //TSPO
                                         {{-1, false, 0}, {TSPO, false, 0}, {TSO, false, 1}, {-1, false, 0}}, //TSO
                                         {{TPS, false, 3}, {-1, false, 0}, {TPOS, false, 2}, {-1, false, 0}}, //TPOS
                                         {{TPS, false, 0}, {-1, false, 0}, {TPOS, false, 2}, {-1, false, 0}}, //TPS
                                         {{TOSP, false, 4}, {TOP, false, 5}, {-1, false, 0}, {-1, false, 0}}, //TOSP
                                         {{TOSP, false, 4}, {TOP, false, 5}, {-1, false, 0}, {-1, false, 0}} //TOP
                                        };

const static switches_type trie_map_exists_3 = {{{-1, false, 0}, {-1, false, 0}, {-1, false, 0}, {SPOT, false, 0}}, //SPOT
                                         {{-1, false, 0}, {-1, false, 0}, {TSPO, true, 0}, {-1, false, 0}}, //SPT
                                         {{-1, false, 0}, {-1, false, 0}, {-1, false, 0}, {-1, false, 0}}, //SO
                                         {{-1, false, 0}, {-1, false, 0}, {-1, false, 0}, {-1, false, 0}}, //ST
                                         {{-1, false, 0}, {-1, false, 0}, {-1, false, 0}, {SPOT, true, 0}}, //POS
