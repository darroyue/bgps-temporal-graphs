...
namespace ltj {
    ...
    namespace veo {
        ...
        public:
            ...
            veo_adaptive(const vector<quad_pattern> *quad_patterns,
                ...
                for (const quad_pattern &quad_pattern : *m_ptr_quad_patterns) {
                    ...
                    if (quad_pattern.t_is_variable()) {
                        ...
                        t = var_to_vector(var_t, size);
                    }

                    // OJO: aqui falta agregar el (o los) caso de t
            ...
            inline var_type next() {
                ...
                if(m_index < m_var_info.size()){ //No lonely
                    ...
                    ++m_index;
                    cout << m_var_info[min_pos].name << " ";
                    return  m_var_info[min_pos].name;
                }else{
                    //Return the next lonely variable
                    ++m_index;
                    cout << m_lonely[m_index-m_var_info.size()-1] << " ";
